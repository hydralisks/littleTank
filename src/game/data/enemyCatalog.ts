...
const DEFAULT_ENEMY_BUFF_DEFINITIONS: EnemyStatusDefinition[] = [
  ...
  {
    statusId: 'challenge_tidefire_magic',
    iconId: 'challenge_tidefire_magic',
    statusName: '潮火交错',
    durationMs: 4500,
    isDispellable: false,
    description: '短时间内强化魔法伤害。',
    effectLogicId: 'challenge_magic_damage_boost_status',
    kind: 'enemyBuff',
    valueA: 0.25,
  },
  {
    statusId: 'challenge_scattered_opening',
    iconId: 'challenge_scattered_opening',
    statusName: '散乱起手',
    durationMs: 0,
    isDispellable: false,
    description: '让目标敌人开场对队伍拥有初始仇恨。',
    effectLogicId: 'challenge_initial_party_threat_status',
    kind: 'enemyBuff',
    valueA: 55,
  },
  {
    statusId: 'challenge_coldlight_guard',
    iconId: 'challenge_coldlight_guard',
    statusName: '寒光护援',
    durationMs: 12000,
    isDispellable: false,
    description: '周期性为目标敌人施加护盾。',
  ...
  {
    statusId: 'challenge_wax_order',
    iconId: 'challenge_wax_order',
    statusName: '蜡影号令',
    durationMs: 18000,
    isDispellable: false,
    description: '周期性强化精英目标。',
  ...
  {
    statusId: 'challenge_tide_order',
    iconId: 'challenge_tide_order',
    statusName: '潮汐军令',
    durationMs: 18000,
    isDispellable: false,
    description: '后排或鱼人单位成功造成伤害时施加潮汐破绽。',
  ...
  {
    statusId: 'challenge_coldlight_barrier',
    iconId: 'challenge_coldlight_guard',
    statusName: '寒光护盾',
    durationMs: 4000,
    isDispellable: false,
    description: '吸收即将受到的伤害。',
    effectLogicId: 'none',
    kind: 'enemyBuff',
    valueA: 20,
  },
  {
    statusId: 'challenge_elite_reinforced',
    iconId: 'challenge_wax_order',
    statusName: '蜡影强化',
    durationMs: 4500,
    isDispellable: false,
    description: '精英目标造成的伤害提高。',
    effectLogicId: 'challenge_magic_damage_boost_status',
    kind: 'enemyBuff',
    valueA: 0.15,
  },
...
const DEFAULT_PLAYER_DEBUFF_DEFINITIONS: EnemyStatusDefinition[] = [
  ...
  {
    statusId: 'challenge_tidal_vulnerability',
    iconId: 'challenge_tidal_vulnerability',
    statusName: '潮汐破绽',
    durationMs: 6000,
    isDispellable: false,
    description: '受到的伤害提高，可叠加至多 5 层。',
    effectLogicId: 'challenge_tidal_vulnerability_status',
    kind: 'playerDebuff',
    valueA: 0.08,
    valueB: 5,
  },
...
const DEFAULT_PARTY_DEBUFF_DEFINITIONS: EnemyStatusDefinition[] = [
  ...
  {
    statusId: 'challenge_tidal_vulnerability_p',
    iconId: 'challenge_tidal_vulnerability',
    statusName: '潮汐破绽',
    durationMs: 6000,
    isDispellable: false,
    description: '受到的伤害提高，可叠加至多 5 层。',
    effectLogicId: 'challenge_tidal_vulnerability_p_status',
    kind: 'partyDebuff',
    valueA: 0.08,
    valueB: 5,
  },
