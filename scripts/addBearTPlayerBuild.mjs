...
const active = [
  ...
  ['ironfur', '铁鬃', '铁鬃', '消耗20点怒气叠加只对物理伤害生效的减伤，默认每层20%且最多3层。', 20, 0, 0, 'self', 'bear_ironfur', 'survival,physical', 'RD-6解锁'],
  ...
  ['barkskin', '树皮术', '树皮', '自身获得10秒30%全伤害减伤，结束时可由天赋驱散减益。', 0, 28000, 0, 'self', 'bear_barkskin', 'survival,dispel', 'WF-3解锁'],
  ['survival_instincts', '生存本能', '本能', '短时间提高最大生命值并获得全伤害减伤。', 0, 90000, 0, 'self', 'bear_survival_instincts', 'survival,max-hp', 'ZA-3解锁'],
  ...
  ['rage_of_the_sleeper', '沉睡者之怒', '沉睡', '成功释放获得25点怒气；自身获得10秒25%最大生命值和25%全伤害减伤，并将部分承伤转化为反击伤害与仇恨。', 20, 45000, 0, 'self', 'bear_rage_of_the_sleeper', 'survival,retaliation,party', 'WF-5解锁'],
...
const activeEffects = [
  ...
  ['ironfur', 'bear_ironfur', 'self', 20, 0, 8000, 'druid_bear_t_ironfur', 0, 0, '每层20%物理减伤，最多3层。'],
  ...
  ['barkskin', 'bear_barkskin', 'self', 0, 0.3, 10000, 'druid_bear_t_barkskin', 0, 0, '10秒30%全伤害减伤。'],
  ...
  ['rage_of_the_sleeper', 'bear_rage_of_the_sleeper', 'self', 0.25, 0.25, 10000, 'druid_bear_t_rage_of_the_sleeper', 0, 0, '10秒25%全伤害减伤、反击和25%最大生命值提升；成功释放获得25怒。'],
...
const activeStatuses = [
  ...
  ['druid_bear_t_barkskin', '树皮术', 'playerBuff', 10000, 1, false, 'playerBuff_bearBarkskin', '10秒30%全伤害减伤。'],
  ...
  ['druid_bear_t_rage_of_the_sleeper', '沉睡者之怒', 'playerBuff', 10000, 1, false, 'playerBuff_bearRageOfTheSleeper', '10秒25%全伤害减伤、反击和25%最大生命值提升。'],
...
const talentRows = [
  ['great_bear_vigor', '巨熊活力', 'player', 2, 'reinforced_plates', 0, '最大生命值提高30%。'], ['thick_hide', '厚皮', 'player', 2, 'bear_physical_reduction', 0, '常驻10%物理减伤，与铁鬃线性叠加。'], ['ursine_threat', '熊威', 'skill', 2, 'bear_threat_multiplier', 0, '熊T技能额外仇恨提高35%。'], ['savage_focus', '野性专注', 'player', 2, 'bear_generator_bonus', 0, '裂伤额外获得7怒。'], ['natural_tenacity', '自然坚韧', 'player', 2, 'bear_control_duration_reduction', 0, '控制类减益持续时间缩短25%。'],
  ['ironfur_reserve', '铁鬃余韵', 'skill', 2, 'bear_ironfur_reserve', 1, '铁鬃结束后获得3秒8%物理减伤。'], ['blood_scent', '血性气息', 'skill', 2, 'bear_blood_scent', 1, '狂暴回复期间首次受伤获得8怒。'], ['skull_bash_instinct', '断法本能', 'skill', 2, 'bear_skull_bash_instinct', 1, '成功打断获得15怒。'], ['broken_bark', '破盾回响', 'skill', 2, 'bear_broken_bark', 1, '吸收盾提前破碎获得12怒。'], ['pack_presence', '兽群威势', 'party', 3, 'bear_pack_presence', 1, '铁鬃两层时队伍获得8%全伤害减伤。'],
  ['moonlit_resolve', '月下坚守', 'skill', 2, 'bear_moonlit_resolve', 2, '月火术存在时熊T获得5%全伤害减伤。'], ['bark_dispelling', '树皮净化', 'skill', 2, 'bear_bark_dispelling', 2, '树皮术结束时解除所有可驱散玩家减益，并治疗当前最大生命值的10%。'], ['regenerative_bond', '回春羁绊', 'party', 1, 'bear_regenerative_bond', 2, '狂暴回复最后一跳治疗队伍5点。'], ['ursoc_shelter', '乌索克庇护', 'party', 3, 'bear_ursoc_shelter', 2, '沉睡者之怒减伤同时作用队伍。'], ['wild_recovery', '野性复原', 'player', 2, 'bear_wild_recovery', 2, '有效治疗后获得短时最大生命值提升。'],
  ['regrowth_of_the_pack', '兽群愈合', 'party', 3, 'bear_regrowth_of_the_pack', 3, '愈合同时治疗队伍原始即时治疗量的50%；持续治疗不治疗队伍。'], ['guardian_of_the_grove', '林地守护者', 'party', 3, 'bear_guardian_of_the_grove', 3, '熊T高于80%生命时队伍获得6%全伤害减伤。'], ['feral_aftershock', '野性余震', 'skill', 2, 'bear_feral_aftershock', 3, '咆哮命中至少2个目标后获得6秒12%物理减伤。'], ['last_bear_stand', '巨熊绝境', 'player', 4, 'bear_last_bear_stand', 3, '每场战斗一次致命伤害保留1生命并获得铁鬃。'], ['spring_returns', '春风吹又生', 'party', 3, 'bear_spring_returns', 3, '每累计获得30怒治疗队伍5点生命。'],
